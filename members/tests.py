...
class ProfileModelTest(TestCase):
    ...
    def test_profile_email_hash_md5(self):
        ...
        udigest = hashlib.md5(email.encode(encoding='utf-8')).hexdigest()
        ldigest = hashlib.md5(email.lower().encode(encoding='utf-8')).hexdigest()
    ...
    def test_profile_email_hash_update(self):
        ...
        digest   = hashlib.md5(newemail.encode(encoding='utf-8')).hexdigest()
